...
RUN apt-get update && apt-get install -y \
    ...
    curl wget vim sudo whois ca-certificates-java \
    && apt-get clean \
...
RUN curl -L -o $SPARK_HOME/jars/hudi-spark3.5-bundle_2.13-0.15.0.jar \
      https://repo1.maven.org/maven2/org/apache/hudi/hudi-spark3.5-bundle_2.13/0.15.0/hudi-spark3.5-bundle_2.13-0.15.0.jar && \
    curl -L -o $SPARK_HOME/jars/spark-avro_2.13-3.5.7.jar \
      https://repo1.maven.org/maven2/org/apache/spark/spark-avro_2.13/3.5.7/spark-avro_2.13-3.5.7.jar && \
    curl -L -o $SPARK_HOME/jars/hadoop-aws-3.3.1.jar \
      https://repo1.maven.org/maven2/org/apache/hadoop/hadoop-aws/3.3.1/hadoop-aws-3.3.1.jar && \
    curl -L -o $SPARK_HOME/jars/aws-java-sdk-bundle-1.11.1026.jar \
